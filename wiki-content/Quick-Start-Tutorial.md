...
![CLI Remember Command](https://superlocalmemory.com/assets/screenshots/cli/cli-remember.png)
...
![CLI Recall Results](https://superlocalmemory.com/assets/screenshots/cli/cli-recall.png)
...
![CLI List Output](https://superlocalmemory.com/assets/screenshots/cli/cli-list.png)
...
![CLI Build Graph](https://superlocalmemory.com/assets/screenshots/cli/cli-build-graph.png)
...
![Dashboard Navigation](https://superlocalmemory.com/assets/gifs/dashboard-tabs.gif)
...
![Knowledge Graph Visualization](https://superlocalmemory.com/assets/screenshots/dashboard/dashboard-graph.png)
*Figure 7: Interactive graph view shows relationships between memories and entities*

![Graph Interaction](https://superlocalmemory.com/assets/gifs/graph-interaction.gif)
...
![Dashboard Timeline View](https://superlocalmemory.com/assets/screenshots/dashboard/dashboard-timeline.png)
...
![Status Command](https://superlocalmemory.com/assets/screenshots/cli/cli-status.png)
*System status showing memory count and graph statistics*

</td>
<td width="50%">

![Remember Command](https://superlocalmemory.com/assets/screenshots/cli/cli-remember.png)
...
![Recall Command](https://superlocalmemory.com/assets/screenshots/cli/cli-recall.png)
*Search results with relevance scores and metadata*

</td>
<td width="50%">

![List Command](https://superlocalmemory.com/assets/screenshots/cli/cli-list.png)
...
![Build Graph](https://superlocalmemory.com/assets/screenshots/cli/cli-build-graph.png)
*Knowledge graph construction with entity extraction*

</td>
<td width="50%">

![Profile Switch](https://superlocalmemory.com/assets/screenshots/cli/cli-profile-switch.png)
...
![Memory Browser](https://superlocalmemory.com/assets/screenshots/dashboard/dashboard-memories.png)
...
![Knowledge Graph](https://superlocalmemory.com/assets/screenshots/dashboard/dashboard-graph.png)
...
![Pattern Learning](https://superlocalmemory.com/assets/screenshots/dashboard/dashboard-patterns.png)
*View learned patterns and confidence scores*

</td>
<td width="50%">

![Filtered Results](https://superlocalmemory.com/assets/screenshots/dashboard/dashboard-filtered.png)
...
![Live Events Stream](https://superlocalmemory.com/assets/screenshots/v25/v25-live-events-working.png)
*Real-time event stream showing memory operations across all agents*

</td>
<td width="50%">

![Agents Tab](https://superlocalmemory.com/assets/screenshots/v25/v25-agents-tab.png)
...
![Dashboard Search](https://superlocalmemory.com/assets/gifs/dashboard-search.gif)
...
![Dashboard Tabs](https://superlocalmemory.com/assets/gifs/dashboard-tabs.gif)
